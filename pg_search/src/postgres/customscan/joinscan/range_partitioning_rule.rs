...
/// falling back to the max document count from the index reader).
...
fn merged_sample(
    ...
    let (l_target_samples, r_target_samples) = match (l_est_rows as usize, r_est_rows as usize) {
        (0, 0) => (0, 0),
